package com.android.githubassignment.api.response
...
class RepoResponse {
    ...
    fun toRepoDisplayData(): RepoDisplayData {
        return RepoDisplayData(
            name = name ?: "",
            number = id ?: 0,
            description =description ?: "",
            userName = owner?.login ?: "",
            userImage = owner?.avatarUrl ?: "https://avatars2.githubusercontent.com/u/7279836?v=4")
    }
